 ...
 */
export declare abstract class AcphastNode extends ClassicPreset.Node {
     ...
     */
    abstract process(inputs: Record<string, Observable<PipelineMessage>[]>, ctx: PipelineContext): Record<string, Observable<PipelineMessage>>;
    /**
     * Set logger instance
     */
 ...
 */
export declare function getNodeMetadata(nodeClass: typeof AcphastNode): NodeMetadata;
/**
