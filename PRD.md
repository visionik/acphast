# Product Requirements Document: Deft Bridge
...
**Project Description**: Agent Client Protocol Front-end and back-end agent-api adapters; together can form an ACP proxy server

**I want to build Deft Bridge that has the following features:**
1. see README.md and docs/*.md for more info
---
